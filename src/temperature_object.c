 ...
 *
 * template generated by anjay_codegen.py on 2020-05-26 16:26:20
 *
...
static int resource_read(anjay_t *anjay,
    ...
    case RID_SENSOR_VALUE:
        ...
        return anjay_ret_float(ctx, current_sensor_value); 

    case RID_SENSOR_UNITS:
        assert(riid == ANJAY_ID_INVALID);
        return anjay_ret_string(ctx, inst->sensor_units); 
    default:
